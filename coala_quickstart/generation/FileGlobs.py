...
def generate_glob_exps(project_files, extensions, project_dir):
    ...
    # Given a list of files, we condense the list into a list of glob
    # expressions which match exactly those files. This will also include
    # a list of exclude globs that exclude all matches.

    # This is done by finding the list of all files in each directory and
    # checking how many are present in the list of files we want to match.
